    ...
    <section id="quem-somos" className="py-24 relative">
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
          {/* Missão */}
          <div className="group p-8 rounded-2xl bg-card border border-border hover:border-primary/50 transition-all duration-500 hover:glow-neon">
            <div className="w-14 h-14 rounded-xl bg-primary/10 flex items-center justify-center mb-6 group-hover:bg-primary/20 transition-colors">
              <Target className="w-7 h-7 text-primary" />
            </div>
            <h3 className="font-orbitron text-xl font-bold mb-4">Missão</h3>
          ...
          <div className="group p-8 rounded-2xl bg-card border border-border hover:border-primary/50 transition-all duration-500 hover:glow-neon">
            ...
            <h3 className="font-orbitron text-xl font-bold mb-4">Visão</h3>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <div className="group p-8 rounded-2xl bg-card border border-border hover:border-primary/50 transition-all duration-500 hover:glow-neon">
            ...
            <h3 className="font-orbitron text-xl font-bold mb-4">Valores</h3>
